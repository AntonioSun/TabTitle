...
const goappEnv = {"GOAPP_INTERNAL_URLS":"null","GOAPP_ROOT_PREFIX":"/TabTitle","GOAPP_STATIC_RESOURCES_URL":"/TabTitle","GOAPP_VERSION":"614bdf137c722709cf759324faefcfe9cc55ad60"};
...
async function goappInitWebAssembly() {
  ...
  try {
    ...
    const wasm = await instantiateStreaming(
      fetchWithProgress("/TabTitle/web/app.wasm", showProgress),
      go.importObject
    );
